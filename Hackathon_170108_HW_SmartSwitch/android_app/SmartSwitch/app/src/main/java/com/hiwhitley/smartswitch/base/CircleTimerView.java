...
public class CircleTimerView extends View
{
    ...
    private static final float DEFAULT_NUMBER_SIZE = 12;
    ...
    // Default color
    private static final int DEFAULT_CIRCLE_COLOR = 0xFF16BB8E;
    private static final int DEFAULT_CIRCLE_BUTTON_COLOR = 0x9016BB8E;
    private static final int DEFAULT_LINE_COLOR = 0xFF8B8B8B;
