...
"if ($('txtType')) $('txtType').value = o.type;"\
"if ($('txtVer')) $('txtVer').value = o.ver;"\
"if ($('txtSerialNum')) $('txtSerialNum').value = o.serial_num;"\
"if ($('txtBuildDate')) $('txtBuildDate').value = o.build_date;"\
...
"if ($('txtSport')) $('txtSport').value = o.sport;"\
"};"\
"</script>"\
"</head>"\
"<body>"\
...
"&copy;Copyright 2014 by zhuogan"\
"</div>"\
