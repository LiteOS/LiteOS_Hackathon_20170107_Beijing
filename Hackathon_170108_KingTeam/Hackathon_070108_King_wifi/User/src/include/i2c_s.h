...
/* GPIO相关宏定义 */
#define IIC_AHB2_CLK	RCC_APB2Periph_GPIOC
#define IIC_AHB2_DAT	RCC_APB2Periph_GPIOD
#define IIC_DATA_PIN	GPIO_Pin_2
#define IIC_SCK_PIN		GPIO_Pin_11
#define IIC_DATA_PORT	GPIOD
#define IIC_SCK_PORT	GPIOC
...
//IO操作函数	 
#define I2C_SCL    PCout(11) //SCL
#define I2C_SDA    PDout(2) //SDA	 
#define SDA_I     PDin(2)  //输入SDA 
