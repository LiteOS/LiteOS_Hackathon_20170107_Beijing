...
//#define FLASH_SAVE_ADDR  0X08000000+0x000f600 	//设置FLASH 保存地址(必须为偶数，且其值要大于本代码所占用FLASH的大小+0X08000000)
//#define FLASH_OffSAVE_ADDR  0X08000000+0x000ff00
//#define FLASH_SAVE_ADDR  0X08000000+0x0f700 	//设置FLASH 保存地址(必须为偶数，且其值要大于本代码所占用FLASH的大小+0X08000000)
#define FLASH_OffSAVE_ADDR  0X08000000+0x000ff00
