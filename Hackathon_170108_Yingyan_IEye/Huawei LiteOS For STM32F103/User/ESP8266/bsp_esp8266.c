...
*/
    ...
    LOS_HwiCreate(39, 0,0,macESP8266_USART_INT_FUN_MY,0);//
...
{    
	...
	//char buffer[RX_BUF_MAX_LEN];
	//memset(buffer,0,RX_BUF_MAX_LEN);
 ...
 * 调用  ：被外部调用
 */
bool ESP8266_Start_UDP ( FunctionalState enumMode, char * pPortNum, char * pTimeOver )
{
	char cCmd1 [120], cCmd2 [120];
